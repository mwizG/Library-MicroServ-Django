"""
Django settings for UsersMS project.
...
SECRET_KEY = 'django-insecure-ymx-o@&*37#(0xrfmc3@%bt#8e^7om@*wrvq4_&3##mv0)zd@5'
...
WSGI_APPLICATION = 'UsersMS.wsgi.application'
