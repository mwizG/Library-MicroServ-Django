...
class BookCreate(APIView):
    def get(self, request):
        book_create_url = 'http://44.223.18.17:8000/new/'  # URL to fetch the book creation form
    ...
    def post(self, request):
        book_create_url = 'http://44.223.18.17:8000/new/'  # URL to post the book creation data
        ...
        if response.status_code == 200:  # Check if the book was created successfully (HTTP 200)
            return redirect('http://44.223.18.17:8001/gateway/home/')  # Redirect to the home page upon successful creation
