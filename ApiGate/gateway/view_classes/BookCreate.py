...
class BookCreate(APIView):
    def get(self, request):
        book_create_url = 'http://bookms:8000/books/new/'  # URL to fetch the book creation form
    ...
    def post(self, request):
        book_create_url = 'http://bookms:8000/books/new/'  # URL to post the book creation data
